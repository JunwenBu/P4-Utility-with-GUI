...
void main(){
  ...
  // do encode print out and do decode print out
  ...
  const std::string ifile="debug\\test.txt";
  const std::string ofile1="debug\\test2.txt";
  const std::string ofile2="debug\\test3.txt";
  try{
    std::cout << "\n  creating encoded string from binary file " 
              << ifile << std::endl;
    std::string encodedString = Base64::encodeFromFile(ifile);
    std::string temp(encodedString.begin(), encodedString.end());
